...
void TCPIP_HTTP_Print_succesFlag(HTTP_CONN_HANDLE connHandle, uint16_t num)       //EventLog1
{
    TCPIP_TCP_StringPut(TCPIP_HTTP_CurrentConnectionSocketGet(connHandle), " ");
}
